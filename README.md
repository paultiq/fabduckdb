...
- [Loop Statements](notebooks/loop_examples.ipynb): Iterates over a the iteration statement, fed as parameters to the template (Jinja2) query
...
- [Dynamic Queries](notebooks/dynamic_examples.ipynb): Executes the quer(ies) dynamically generated by the inner select
...
- [Pseudo-Table Functions](notebooks/function_examples.ipynb): Extracts and rewrites embedded functions.
